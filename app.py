...
if uploaded_file is not None:
    ...
    prompt1 = """
あなたは、転職希望者との面談音声から正確で詳細な議事録を作成する専門家です。以下の指示に従って、高品質な議事録を作成してください。
...
7. 個人情報や機密情報には十分注意し、適切に取り扱ってください。

## 項目別の指示

1. 求職者の興味関心
   - 求職者が興味関心を持っている趣味や嗜好を詳細に記録してください。
   - 各話題について、その理由も含めて記載してください。

2. 過去や学生時代での経験
   - 学生時代の主要な経験、成果、学んだことを時系列で記録してください。

3. 大学卒業後からの経歴
   - 就職後の職歴を時系列で詳細に記録してください。
   - 各職場での役職、期間、主な責任を含めてください。

4. 入社理由（意思決定理由）
   - 現在の会社に入社した理由を具体的に記載してください。

5. スキル・経験
   - 職務に関連する主要なスキルと経験を詳細に記録してください。
   - 可能であれば、各スキルの熟練度も記載してください。

6. 経験した業務内容
   - これまでの職歴で経験した主な業務内容を具体的に記述してください。

7. 転職理由
   - 現在の転職を考えている理由を詳細に記録してください。

8. 価値基準
   - 求職者の仕事や人生における価値観を明確に記載してください。

9. 希望職種
   - 転職先で希望する職種や役割を具体的に記録してください。

10. 希望勤務地
    - 希望する勤務地や地域、転勤の可能性についての考えを記載してください。

11. 次の転職先に求めること
    - 新しい職場に期待することを具体的に列挙してください。

12. 転職における条件
    - 給与、福利厚生、労働時間など、転職の際の具体的な条件を記録してください。

13. キャリアビジョン・目標
    - 短期的および長期的なキャリア目標を詳細に記載してください。

14. 入社希望日
    - 希望する入社日や、現在の仕事の引き継ぎに必要な期間を記録してください。

15. 転職活動スケジュール
    - 転職活動の予定や目標とする期間を記載してください。

16. 選考可能日程
    - 面接や選考に参加可能な日程や時間帯を記録してください。

17. 他社・選考状況
    - 他社での選考状況や、内定の有無を詳細に記載してください。

18. 他社サービス利用状況
    - 他の転職エージェントや転職サイトの利用状況を記録してください。

19. マッチしそうな企業文化
    - 求職者の性格や価値観に合いそうな企業文化について記載してください。
...
この指示に従って、正確で詳細、かつ有用な転職希望者の面談議事録を作成してください。特に、企業への推薦文は、求職者の魅力を最大限に引き出し、具体的かつ説得力のある内容になるよう注意してください。不明な点がある場合は、必ず確認を求めてください。
    """
